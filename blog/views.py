...
from blog.forms import ProductForm,UpdateProductForm ,RegisterUserForm,LoginUserForm #for add product form
from django.db.models import Avg
from django.conf import settings
from blog.models import Product, Cart ,Reviews,Orders
